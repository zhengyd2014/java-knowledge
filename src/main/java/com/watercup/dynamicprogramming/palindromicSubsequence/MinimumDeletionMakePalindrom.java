...
public class MinimumDeletionMakePalindrom {
    /*
    ...
    not part of LPS must be removed. Please note that it is ‘Longest Palindromic SubSequence’
    and not ‘Longest Palindrome Substring’.
    ...
    # similar question
        ...
        exactly the same solution.  find the longest palindromic subsequence,
        insert the characters not in the LPS.
     */
    ...
    public static void main(String[] args) {
        MinimumDeletionMakePalindrom mdsp = new MinimumDeletionMakePalindrom();
